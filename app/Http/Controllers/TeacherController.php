...
class TeacherController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('docentes.index')->with(compact('teachers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('docentes')->with('success', 'El docente se ha registrado exitosamente.');
    }

    public function edit($id)
    {
        $teacher = User::find($id);
        return view('docentes.edit')->with(compact('teacher'));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        $user->save();
        return back()->with('success', 'Los datos del docente se han modificado exitosamente.');
    }
    ...
    public function destroy($id)
    {
        $teacher = User::find($id);
        $teacher->delete();
        return back()->with('success', 'El docente se ha eliminado de la base de datos.');
    }
