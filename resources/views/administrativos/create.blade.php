...
@section('sub-title', 'Formulario para el registro de administrativos')
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Registrar un nuevo administrativo</h3>
    ...
    <div class="box-body">
        ...
        <form action="{{ url('administrativos/registrar') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <button type="submit" class="btn btn-success pull-right">Registrar administrativo</button>
                </div>
            </div>
