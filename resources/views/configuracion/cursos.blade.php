    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box">
                ...
                <div class="box-body">
                    <p>Es necesario definir los cursos que se dictarán en la institución.</p>
                    <p>Los cursos serán asociados a las carreras, pero es necesario que sean creados de manera independiente.</p>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Cursos impartidos en el instituto</h3>
                    <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Minimizar"><i class="fa fa-minus"></i></button>
                    </div>
                </div>
