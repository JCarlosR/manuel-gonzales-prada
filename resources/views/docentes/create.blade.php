...
@section('sub-title', 'Formulario para el registro de docentes')
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Registrar un nuevo docente</h3>
        ...
        <form action="{{ url('docentes/registrar') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <button type="submit" class="btn btn-success pull-right">Registrar docente</button>
                </div>
            </div>
