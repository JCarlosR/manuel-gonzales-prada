...
<html>
  <head>
    ...
    <title>Instituto superior | @yield('title')</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ url('/') }}" class="logo">
          ...
          <span class="logo-lg"><b>Sistema</b> Académico</span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="{{ asset('dist/img/user2-160x160.jpg') }}" class="img-circle" alt="User Image">
                    <p>
                        {{ Auth::user()->last_name }} - {{ Auth::user()->role->name }}
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ url('/docentes') }}"><i class="fa fa-circle-o"></i> Gestionar docentes</a></li>
                    <li><a href="{{ url('/administrativos') }}"><i class="fa fa-circle-o"></i> Gestionar administrativos</a></li>
                    <li><a href="{{ url('/alumnos') }}"><i class="fa fa-circle-o"></i> Gestionar alumnos</a></li>
                </ul>
            </li>
            <li class="treeview">
              <a href="#">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016 Manuel Gonzales Prada.</strong> All rights reserved.
      </footer>
